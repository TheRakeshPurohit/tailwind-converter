      ...
      <div className="grid gap-8 lg:grid-cols-[1fr_1fr]">
        <section>
          ...
          <ol className="mt-4 space-y-3 text-sm leading-6 text-muted-foreground">
            <li>1. CSS is parsed into rules, selectors, at-rules, and declarations.</li>
            <li>2. Safe selectors are matched against the input HTML.</li>
            <li>3. Supported pseudo-classes become Tailwind variants like hover.</li>
            <li>4. Default Tailwind media queries become responsive prefixes.</li>
            <li>5. Safe shorthands are expanded before declaration conversion.</li>
